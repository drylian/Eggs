...
while True:
    ...
    resposta_http += '<!DOCTYPE html>'\
                    ...
                    '<head>'\
                        ...
                        '<link rel="shortcut icon" href="https://raw.githubusercontent.com/drysius/Eggs/main/Connect/Templates/imgs/python.png" type="image/png" style="border-radius: 50px;">'\
                        '<link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet">'\
                    '</head>'\
                    '<body class="bg-gray-100">'\
                        '<div class="flex justify-center items-center flex-col mx-auto px-4 py-8">'\
                        '<img class="w-36 h-36" src="https://raw.githubusercontent.com/drysius/Eggs/main/Connect/Templates/imgs/python.png"/>'\
